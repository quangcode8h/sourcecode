...
<head>
    ...
    <link rel="stylesheet" href="./public/css/product-item.css">
    ...
    <section class="breadcrumbbar">
        <div class="container">
            <ol class="breadcrumb mb-0 p-0 bg-transparent">
                ...
                <li class="breadcrumb-item"><a href="#"><?php echo $MainCategory['TenDm']  ?></a></li>
                <li class="breadcrumb-item active"><a href="#"><?php echo $ChildCategory['TenDMCon'] ?></a></li>
            </ol>
        </div>
    </section>
                    ...
                    <div class="col-md-5 khoianh">
                        <div class="anhto mb-4">
                            <a class="active" href="#" data-fancybox="thumb-img">
                                <img class="product-image" src="<?php echo $BookDetails['AnhBia'] ?>"style="width: 100%;">
                            </a>
                            <a href="./public/images/lap-ke-hoach-kinh-doanh-hieu-qua-ms.jpg" data-fancybox="thumb-img"></a>
                        </div>
                        <div class="list-anhchitiet d-flex mb-4" style="margin-left: 2rem;">
                            <img class="thumb-img thumb1 mr-3" src="./public/images/lap-ke-hoach-kinh-doanh-hieu-qua-mt.jpg" class="img-fluid" alt="lap-ke-hoach-kinh-doanh-hieu-qua-mt">
                            <img class="thumb-img thumb2" src="./public/images/lap-ke-hoach-kinh-doanh-hieu-qua-ms.jpg" class="img-fluid" alt="lap-ke-hoach-kinh-doanh-hieu-qua-ms">
                        </div>
                    </div>
                    ...
                    <div class="col-md-7 khoithongtin">
                        <div class="row">
                            <div class="col-md-12 header">
                                <h4 class="ten"><?php echo $BookDetails['TenSach'] ?></h4>
                                <div class="rate">
                            ...
                            <div class="col-md-7">
                                <div class="gia">
                                    <div class="giabia">Giá bìa:<span class="giacu ml-2"><?php echo $BookDetails['GiaBan'] ?></span></div>
                                    <div class="giaban">Giá bán tại DealBooks: <?php echo ($BookDetails['GiaBan'] - $BookDetails['GiaBan'] * $BookDetails['GiamGia']/100) ?></div>
                ...
                <div class="khoisanpham" style="padding-bottom: 2rem;">
                    ...
                    <div class="card">
                        <a href="" class="motsanpham" style="text-decoration: none; color: black;" data-toggle="tooltip"
                            ...
                            <img class="card-img-top anh" src="./public/./public/images/lap-ke-hoach-kinh-doanh-hieu-qua.jpg" alt="lap-ke-hoach-kinh-doanh-hieu-qua">
                    ...
                    <div class="card">
                        ...
                        Trí">
                            <img class="card-img-top anh" src="./public/./public/images/ma-bun-luu-manh.jpg" alt="ma-bun-luu-manh">
                            <div class="card-body noidungsp mt-3">
                    ...
                    <div class="card">
                        <a href="#" class="motsanpham" style="text-decoration: none; color: black;" data-toggle="tooltip"
                            ...
                            <img class="card-img-top anh" src="./public/./public/images/bank-4.0.jpg" alt="bank-4.0">
                            <div class="card-body noidungsp mt-3">
                    ...
                    <div class="card">
                        ...
                        Tình Thân (Bộ 8 Cuốn)">
                            <img class="card-img-top anh" src="./public/./public/images/bo-sach-500-cau-chuyen-dao-duc.jpg" alt="bo-sach-500-cau-chuyen-dao-duc">
                            <div class="card-body noidungsp mt-3">
                    ...
                    <div class="card">
                        <a href="#" class="motsanpham" style="text-decoration: none; color: black;" data-toggle="tooltip"
                            ...
                            <img class="card-img-top anh" src="./public/./public/images/ung-thu-hoang-de-cua-bach-benh.jpg" alt="ung-thu-hoang-de-cua-bach-benh">
                            <div class="card-body noidungsp mt-3">
                    ...
                    <div class="card">
                        <a href="#" class="motsanpham" style="text-decoration: none; color: black;" data-toggle="tooltip"
                            ...
                            <img class="card-img-top anh" src="./public/./public/images/troi-dem-huyen-dieu.jpg" alt="troi-dem-huyen-dieu">
                            <div class="card-body noidungsp mt-3">
                    ...
                    <div class="card">
                        <a href="#" class="motsanpham" style="text-decoration: none; color: black;" data-toggle="tooltip"
                            ...
                            <img class="card-img-top anh" src="./public/./public/images/bo-sach-nhung-cau-chuyen-cho-con-thanh-nguoi-tu-te.jpg" alt="bo-sach-nhung-cau-chuyen-cho-con-thanh-nguoi-tu-te">
                            <div class="card-body noidungsp mt-3">
                    ...
                    <div class="card">
                        <a href="#" class="motsanpham" style="text-decoration: none; color: black;" data-toggle="tooltip"
                            ...
                            <img class="card-img-top anh" src="./public/./public/images/lich-su-the-gioi.jpg" alt="lich-su-the-gioi">
                            <div class="card-body noidungsp mt-3">
                ...
                <div class="khoisanpham">
                    ...
                    <div class="card">
                        <a href="#" class="motsanpham" style="text-decoration: none; color: black;" data-toggle="tooltip"
                            ...
                            <img class="card-img-top anh" src="./public/./public/images/combo-chuyen-nghe-chuyen-doi.jpg" alt="combo-chuyen-nghe-chuyen-doi">
                            <div class="card-body noidungsp mt-3">
                    ...
                    <div class="card">
                        <a href="#" class="motsanpham" style="text-decoration: none; color: black;" data-toggle="tooltip"
                            ...
                            <img class="card-img-top anh" src="./public/./public/images/combo-me-con-su-tu-bo-tat-ngan-tay-ngan-mat.jpg" alt="combo-me-con-su-tu-bo-tat-ngan-tay-ngan-mat">
                            <div class="card-body noidungsp mt-3">
                    ...
                    <div class="card">
                        <a href="#" class="motsanpham" style="text-decoration: none; color: black;" data-toggle="tooltip"
                            ...
                            <img class="card-img-top anh" src="./public/./public/images/combo-hanh-phuc-sang-tao.jpg" alt="combo-hanh-phuc-sang-tao">
                            <div class="card-body noidungsp mt-3">
                    ...
                    <div class="card">
                        <a href="#" class="motsanpham" style="text-decoration: none; color: black;" data-toggle="tooltip"
                            ...
                            <img class="card-img-top anh" src="./public/./public/images/combo-giao-duc-va-y-nghia-cuoc-song.jpg" alt="combo-giao-duc-va-y-nghia-cuoc-song">
                            <div class="card-body noidungsp mt-3">
                    ...
                    <div class="card">
                        <a href="#" class="motsanpham" style="text-decoration: none; color: black;" data-toggle="tooltip"
                            ...
                            <img class="card-img-top anh" src="./public/./public/images/combo-dinh-duong-than-duoc-xanh.jpg" alt="combo-dinh-duong-than-duoc-xanh">
                            <div class="card-body noidungsp mt-3">
                    ...
                    <div class="card">
                        <a href="#" class="motsanpham" style="text-decoration: none; color: black;" data-toggle="tooltip"
                            ...
                            <img class="card-img-top anh" src="./public/./public/images/combo-an-xanh-song-lanh.jpg" alt="combo-an-xanh-song-lanh">
                            <div class="card-body noidungsp mt-3">
                    ...
                    <div class="card">
                        <a href="#" class="motsanpham" style="text-decoration: none; color: black;" data-toggle="tooltip"
                            ...
                            <img class="card-img-top anh" src="./public/./public/images/combo-luoc-su-loai-nguoi.jpg" alt="combo-luoc-su-loai-nguoi">
                            <div class="card-body noidungsp mt-3">
                    ...
                    <div class="card">
                        <a href="#" class="motsanpham" style="text-decoration: none; color: black;" data-toggle="tooltip"
                            ...
                            <img class="card-img-top anh" src="./public/./public/images/combo-phong-cach-song.jpg" alt="combo-phong-cach-song">
                            <div class="card-body noidungsp mt-3">
